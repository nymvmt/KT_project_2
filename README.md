...
- 🚀 자동화된 배포: CI/CD 파이프라인으로 코드 변경 시 자동 테스트, 빌드, 배포
- 🤖 익명 닉네임 자동 생성: Azure OpenAI 기반 별칭 제너레이터로 대화 허들을 낮추고 심리적 안전감 확보
- 🧾 영수증 OCR 정산: 영수증 업로드 시 상호·일자·라인아이템·합계 자동 추출로 정산 준비 및 랜덤 분배 
- 🖼️ 약속 포스터/배너 자동 생성: 모임 키워드로 한 장 이미지 생성해 홍보·공유 경험 강화
...
![IMG_0488](https://github.com/user-attachments/assets/7a30d892-a2a9-4104-a212-835079013718)
